...
var nav = navigator,
	...
	options = {
		...
		startDelay: 5000,			// 5 seconds from page load before the balloon appears
		lifespan: 360000,			// 360 seconds before it is automatically destroyed
	...
	intl = {
		...
		en_us: 'Install this web app on your %device by tapping "%icon" then "Add to Home Screen".',
